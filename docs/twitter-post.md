...
I turned the workflow into 13 reusable Codex/Claude skills:

- read-only disk accounting
- exact paths + sizes
- APFS vs du gap explanation
- screen recordings / Photos / wallpaper assets / VM checks
- app inventory, browser cache, launch agent, dev cache, archive, image, PDF, plist, screenshots, CSV, backup audits
